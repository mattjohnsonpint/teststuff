...
running command...
$ mynewcli (--version)
mynewcli/0.0.0 darwin-arm64 node-v22.10.0
...
_See code: [src/commands/hello/index.ts](https://github.com/mattjohnsonpint/mynewcli/blob/v0.0.0/src/commands/hello/index.ts)_
...
_See code: [src/commands/hello/world.ts](https://github.com/mattjohnsonpint/mynewcli/blob/v0.0.0/src/commands/hello/world.ts)_
